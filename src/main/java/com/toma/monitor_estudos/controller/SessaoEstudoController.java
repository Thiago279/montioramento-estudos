...
public class SessaoEstudoController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "Matéria associada não foi encontrada")
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "Sessão de estudo não encontrada para exclusão")
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Dados de entrada inválidos"),
            @ApiResponse(responseCode = "404", description = "Sessão de estudo ou Matéria não foi encontrada")
    })
