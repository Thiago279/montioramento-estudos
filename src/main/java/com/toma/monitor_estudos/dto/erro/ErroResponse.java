...
public record ErroResponse(
        ...
        @Schema(description = "Mensagem detalhada do erro ou falha de validação", example = "Matéria não encontrada com o ID informado")
        String message,

        @Schema(description = "Rota/Endpoint onde ocorreu a exceção", example = "/monitor-estudos/materias/99")
        String path
) {}
